...
- **`llms-full.txt`**: a single-file monolith (~250 KB). Contains the raw text of the hand-written guides plus the source docstrings and signatures of every built-in operation, fact, and connector.
